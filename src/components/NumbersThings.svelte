...
<div class="widget">
  ...
  <input type="range" min="0" max="255" bind:value={n} class="slider" />
  <div class="meanings">
...
<div class="widget">
  ...
  <div class="w-row" style="gap:30px">
    <div style="flex:1;min-width:200px">
      <div class="rgb-row"><label>R</label><input type="range" min="0" max="255" bind:value={r} class="slider r" /><span>{r}</span></div>
      <div class="rgb-row"><label>G</label><input type="range" min="0" max="255" bind:value={g} class="slider g" /><span>{g}</span></div>
      <div class="rgb-row"><label>B</label><input type="range" min="0" max="255" bind:value={b} class="slider b" /><span>{b}</span></div>
    </div>
    <div class="lead">
