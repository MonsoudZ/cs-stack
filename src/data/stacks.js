...
export const stacks = [
  ...
  { slug: 'database', name: 'Database', kind: 'stack', layer: '18', accent: '#ffb454', blurb: 'indexes, B-trees, transactions, and durability' },
  { slug: 'render', name: 'Render', kind: 'pipeline', layer: '19', accent: '#a78bfa', blurb: 'DOM, style, layout, paint, and compositing' },
];
