...
export const compilerLayers = [
  ...
  { id: 'KR', num: '06', navLabel: 'Registers', zone: 'system', title: 'SSA & registers: fitting values into hardware', sub: 'compiler · single assignment · liveness · spilling' },
  { id: 'K6', num: '07', navLabel: 'Run', zone: 'system', title: 'Run: interpret, compile, or JIT', sub: 'runtime · VM · AOT · just-in-time' },
  { id: 'K7', num: '08', navLabel: 'The pipeline', zone: 'all', title: 'One pipeline, text to execution', sub: 'the whole trip · source → tokens → tree → ops' },
];
