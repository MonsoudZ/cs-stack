...
export const networkLayers = [
  ...
  { id: 'N5', num: '05', navLabel: 'Sockets', zone: 'system', title: 'Sockets: one port, thousands of connections', sub: 'transport · ip:port · the 4-tuple · demux' },
  { id: 'N6', num: '06', navLabel: 'HTTP', zone: 'meaning', title: 'HTTP: the conversation over the wire', sub: 'application · request · response · status codes' },
  { id: 'N7', num: '07', navLabel: 'The request', zone: 'all', title: 'One request, all the way out and back', sub: 'the whole trip · DNS → TCP → TLS → HTTP' },
];
