...
export const dbLayers = [
  ...
  { id: 'D4', num: '04', navLabel: 'Durability', zone: 'system', title: 'Durability: surviving a crash', sub: 'database · the write-ahead log' },
  { id: 'D5', num: '05', navLabel: 'Replication', zone: 'all', title: 'Replication: copies that survive', sub: 'the whole trip · scale & failover' },
];
